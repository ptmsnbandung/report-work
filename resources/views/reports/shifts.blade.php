    ...
    <div class="report-hero-header">
        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-2.5">
            <div class="d-flex align-items-center gap-2.5">
                <div class="page-title-icon-box shadow-xs flex-shrink-0" style="background: linear-gradient(135deg, #8b5cf6, #6d28d9); box-shadow: 0 4px 12px rgba(139, 92, 246, 0.45); border: 1px solid rgba(255, 255, 255, 0.2); width: 42px; height: 42px; border-radius: 12px; display: flex; align-items: center; justify-content: center; color: #fff; font-size: 1.15rem;">
            ...
            <div class="d-flex align-items-center gap-2 flex-wrap">
                <a href="{{ route('reports.export.shifts.pdf', request()->query()) }}" class="btn btn-report-export-pdf btn-sm rounded-pill px-3.5 py-1.5 shadow-xs d-inline-flex align-items-center gap-1.5" style="font-size: 0.78rem; min-height: 32px;" title="Export PDF">
                    <i class="bi bi-file-earmark-pdf-fill" style="color: #fca5a5;"></i>
                    <span>Export PDF</span>
                </a>
                <a href="{{ route('reports.export.shifts.excel', request()->query()) }}" class="btn btn-report-export-excel btn-sm rounded-pill px-3.5 py-1.5 shadow-xs d-inline-flex align-items-center gap-1.5" style="font-size: 0.78rem; min-height: 32px;" title="Export Excel">
