...
<div class="container-fluid px-0 pb-5 mb-5">
    ...
    <!-- ── PAGE HEADER ── -->
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-3 p-3 px-md-3.5 rounded-xl bg-white shadow-xs border border-light">
        <div class="d-flex align-items-center gap-2.5">
            ...
            <div>
                <h1 class="page-title-text mb-0 fw-bold text-navy" style="font-size:1.15rem;">
                    Key Performance Indicators (KPI) & Evaluasi Kinerja
                </h1>
                <p class="text-muted small mb-0" style="font-size:0.75rem; margin-top:2px;">
