    ...
    <div class="card border-0 shadow-sm rounded-xl mb-3 bg-white p-3 p-md-3.5">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
            <div class="d-flex align-items-center gap-2.5">
                <div class="page-title-icon-box shadow-xs" style="background: linear-gradient(135deg, #2563eb, #1e40af); box-shadow: 0 4px 12px rgba(37, 99, 235, 0.35);">
                ...
                <div>
                    ...
                    <p class="text-muted small mb-0 d-none d-sm-block" style="font-size: 0.75rem; margin-top: 2px;">
                        Monitoring kepatuhan SLA, kecepatan respon, interval laporan 30 menit, dan durasi verifikasi NOC
                    </p>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center gap-2 flex-wrap flex-sm-nowrap w-100 w-md-auto justify-content-start justify-content-md-end">
                <a href="{{ route('reports.export.kpi.pdf', request()->query()) }}" class="btn btn-outline-danger btn-sm rounded-pill px-3 shadow-xs d-inline-flex align-items-center justify-content-center gap-1.5 flex-fill flex-sm-grow-0" style="min-height: 35px;">
                    <i class="bi bi-file-earmark-pdf-fill"></i>
                    <span>Export PDF</span>
                </a>
                <a href="{{ route('reports.export.kpi.excel', request()->query()) }}" class="btn btn-outline-success btn-sm rounded-pill px-3 shadow-xs d-inline-flex align-items-center justify-content-center gap-1.5 flex-fill flex-sm-grow-0" style="min-height: 35px;">
